...
```
ANTHROPIC_API_KEY=jouw-eigen-key-hier
```
...
Om je eigen data te analyseren: vervang de CSV of pas het pad aan in `audit.py` (regel met `load_keywords(...)`). Verwachte kolommen: `keyword, impressions, clicks, cost, conversions, CPA`.

## Voorbeeldoutput

Zie `output/audit_rapport_20260823_101848.md` voor een gegenereerd voorbeeldrapport op basis van de meegeleverde test-data.
